/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bec4fccc22a03255f8a6ff4f5a8839fd)
...
interface __BaseEnv_Env {
	...
	DURABLE_OBJECT_SERVICE: string;
	DURABLE_FS_OBJECT: DurableObjectNamespace<import("./src/index").DurableFsObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "DurableFsObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "QDRANT_BASE_URL" | "QDRANT_API_KEY" | "QDRANT_COLLECTION_NAME" | "INTERNAL_API_KEY" | "DURABLE_OBJECT_SERVICE">> {}
}
declare module "*.wasm" {
...
declare namespace Cloudflare {
	...
	//       durableNamespaces: "DurableFsObject" | "AnotherDurableObject";
	//     }
	//
